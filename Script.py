...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,ɪ ᴀᴍ ʙᴏᴛ ᴡʜɪᴄʜ ʜᴀᴠᴇ ᴍᴏʀᴇ ᴛʜᴇɴ 1 ʟᴀᴋʜ +  ғɪʟᴇs ᴏɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ . ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ᴀɴᴅ sᴇʀɪᴇs

ʙᴜᴛ..! ɴᴏᴛ ᴛʜᴇᴀᴛʀᴇ ᴘʀɪɴᴛs 🚫.sᴏ ᴅᴏɴᴛ sᴇᴀʀᴄʜ ᴛʜᴇᴀᴛʀᴇ ᴘʀɪɴᴛs 😉</b>"""
...
• /delall - <code>ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴡʜᴏʟᴇ ꜰɪʟᴛᴇʀꜱ ɪɴ ᴀ ᴄʜᴀᴛ (ᴄʜᴀᴛ ᴏᴡɴᴇʀ ᴏɴʟʏ)</code>"""
    ...
    # Don't Remove Credit 
# Subscribe YouTube Channel For Amazing 
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/MOVIE_LOVERZZ)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/MOVIE_LOVERZZ>☢Join Main channel☢</a></b> 
...
QR CODE:- 👉<a href=https://t.ly/0RrPE>QRCODE</a> (Open Link,Save QR and Pay)
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
🫣 If you Want Movie First Join Our Main channel then click on try again😅"""
...
-Dev 1 [Owner of this bot ]<a href='http://t.me/MovieLoverz_Admin_bot'>ⁱᵗᶻ ᵐᵉ ᵗᵍ 🇮🇳</a>

-Dev 2 <a href='https://t.me/MOVIE_LOVERZZ'>ML</a>

-Dev 3 <a href='https://t.me/MOVIE_LOVERZZ>Jᴏᴇʟ </> TɢX</a>

- Dev 4 <a href=''>TEAM VJ</a>
"""
